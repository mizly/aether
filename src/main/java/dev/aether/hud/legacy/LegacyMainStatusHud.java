...
/**
 * Pre-Ryn rendering for the Main Status HUD. Preserves the animated header/content
 * lerps, session profit tile, rest bar, and BPS/Next-Rest grid.
 */
public final class LegacyMainStatusHud {
    public static final float W          = 210f;
    public static final float PAD_H      = 12f;
    public static final float PAD_V      = 10f;
    public static final float CORNER     = 5f;
    public static final float ICON_BOX   = 30f;
    public static final float HEADER_H   = PAD_V + ICON_BOX + PAD_V;
    public static final float STATE_SZ   = 12f;
    public static final float LOC_SZ     = 9f;
    public static final float LABEL_SZ   = 9f;
    public static final float VAL_SZ     = 14f;
    public static final float SES_SZ     = 10f;
    public static final float ROW_SZ     = 10f;
    public static final float ROW_H      = 16f;
    public static final float SEP_H      = 1f;
    public static final float BOX_R      = 4f;
    public static final float BOX_PAD_H  = 8f;
    public static final float BOX_PAD_V  = 6f;
    public static final float BAR_H      = 3f;

    public static final float CONTENT_H =
              SEP_H + 8f
            + LABEL_SZ + 3f + VAL_SZ + 6f
            + ROW_H + ROW_H + ROW_H + ROW_H
            + 6f + BAR_H + 8f
            + (BOX_PAD_V * 2f + LABEL_SZ + 4f + SES_SZ)
            + PAD_V;

    public static final float HEIGHT = HEADER_H + CONTENT_H;
    ...
    private static float macroLerp   = -1f;
    private static float farmingLerp = -1f;
    private static float contentH    = -1f;

    private LegacyMainStatusHud() {}
    ...
    private static void infoRow(NVGRenderer nvg, float y, String label, String value, int valColor) {
        float cy    = y + ROW_H / 2f;
